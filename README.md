...
Automatically finishes the branch by creating a PR to `develop`.
...
sequenceDiagram
    ...
    D->>R: bflow → start release fix (auto-creates release/2.6)
...
└── menu.rs              — Interactive menus via dialoguer
```
