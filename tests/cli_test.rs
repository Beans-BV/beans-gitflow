...
fn start_fix_returns_start_work_branch_action() {
    let cmd = Commands::Start { kind: StartKind::Fix { name: "bug".to_string(), base: "develop".to_string() } };
    let branch_type = BranchType::Develop;
    let action = resolve_action(cmd, &branch_type).unwrap();
...
fn start_chore_returns_start_work_branch_action() {
    let cmd = Commands::Start { kind: StartKind::Chore { name: "deps".to_string(), base: "develop".to_string() } };
    let branch_type = BranchType::Develop;
    let action = resolve_action(cmd, &branch_type).unwrap();
...
fn start_docs_returns_start_work_branch_action() {
    let cmd = Commands::Start { kind: StartKind::Docs { name: "readme".to_string(), base: "develop".to_string() } };
    let branch_type = BranchType::Develop;
    let action = resolve_action(cmd, &branch_type).unwrap();
...
fn start_refactor_returns_start_work_branch_action() {
    let cmd = Commands::Start { kind: StartKind::Refactor { name: "cleanup".to_string(), base: "develop".to_string() } };
    let branch_type = BranchType::Develop;
    let action = resolve_action(cmd, &branch_type).unwrap();
